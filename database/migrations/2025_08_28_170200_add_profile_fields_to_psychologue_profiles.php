...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('psychologue_profiles', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('psychologue_profiles', 'numero_carte_professionnelle')) {
                $table->string('numero_carte_professionnelle')->nullable();
            }
            if (!Schema::hasColumn('psychologue_profiles', 'moyens_paiement')) {
                $table->json('moyens_paiement')->nullable();
            }
            if (!Schema::hasColumn('psychologue_profiles', 'moyens_transport')) {
                $table->json('moyens_transport')->nullable();
            }
            if (!Schema::hasColumn('psychologue_profiles', 'informations_pratiques')) {
                $table->text('informations_pratiques')->nullable();
            }
            if (!Schema::hasColumn('psychologue_profiles', 'jours_disponibles')) {
                $table->json('jours_disponibles')->nullable();
            }
            if (!Schema::hasColumn('psychologue_profiles', 'contact_urgence')) {
                $table->string('contact_urgence')->nullable();
            }
            if (!Schema::hasColumn('psychologue_profiles', 'rdv_patients_suivis_uniquement')) {
